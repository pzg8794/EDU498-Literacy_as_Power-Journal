...
\vspace{-2em}
\centering
\includegraphics[width=0.5\textwidth,height=0.5\textheight,keepaspectratio]{images/UDL_for_computer_science.png}
{\scriptsize\textit{Figure 7. CAST UDL Guidelines 3.0 is the present-day initiative connecting communication access, learner variability, and inclusive instructional design.}\par}
\vspace{-1em}
\end{wrapfigure}
...
\vspace{-1em}
\centering
\includegraphics[width=0.5\textwidth,height=0.5\textheight,keepaspectratio]{images/UDL_for_chronically_ill_and_neurodivergents.png}
...
\vspace{-1em}
\centering
\includegraphics[width=0.5\textwidth,height=0.5\textheight,keepaspectratio]{images/UDL_CAST_social_media.png}
...
% Syllabi, assignment instructions, grading policies, and accommodation pathways could similarly be prepared in full detail and plain language versions without reducing rigor.
