\begin{center}
{\Large\bfseries\color{PrimaryRed} Literacy as Power: Communication Access, Neurodivergence, and Social Justice in STEM Education}\\[0.35em]
{\normalsize Piter Zgorzelski \textbar{} Literacy Learning as Social Practice \textbar{} Summer 2026}
\end{center}

\draftnote{\textbf{Working draft note:} This draft uses the visual structure from the Minecraft identity mini-unit template. Final revision should add course-reading citations, replace figure placeholders with final visuals, and tighten transitions after review.}
